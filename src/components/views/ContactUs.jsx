    ...
    return (
        <section id="contact" className="py-20 bg-gray-100">
            <div className="container mx-auto max-w-lg">
                ...
                <form action="https://formspree.io/f/mdkdzplw" method="POST" className="space-y-4">
                    ...
                    <textarea name="message" rows={5} placeholder="Your Message" required className="w-full p-3 border rounded" />
